  ...
  const singout = ()=>{
    ...
    return (
        <div className="p-6 min-h-screen flex justify-center items-center">
            <div className="  border-2  shadow-lg rounded-lg p-8 max-w-lg w-full text-center">
                <h3 className="text-3xl font-bold text-white bg-sky-400 rounded-xl mb-6">Admin Profile</h3>
                ...
                <div className="mt-4">
                    <h4 className="lg:text-2xl text-xl font-semibold text-sky-500">Admin Name: {user?.displayName || 'Admin Name'}</h4>
                ...
                <div className='py-3 space-x-3'>
                    ...
                    <Link className='/'>
                    <button className='btn font-bold text-white bg-sky-400'>
                        Back to Home
                         </button></Link>
                </div>
